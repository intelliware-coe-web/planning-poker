...
export function CreateUser({postUser}) {
    ...
    return (
        <div className="uk-container uk-flex uk-flex-middle uk-height-viewport login">
            <div className="uk-text-center"><h2>Welcome to planning poker</h2></div>
            <div className="uk-width-1-2@s uk-width-3-4@m"><img src={loginImg} alt="login"/></div>
            <div>
                <form onSubmit={event => {
                    ...
                    <div className="uk-margin">
                        ...
                        <input className="uk-button uk-button-primary uk-width-1-1 uk-margin-small-top" type="submit" value="CREATE"/>
                    </div>
                </form>
            </div>
        </div>
